...
(defun sense-region-set-word (&optional position) ; mell 陦後″縺九↑?
  (interactive)
...
(defun sense-region-set-next-word (&optional position) ; mell 陦後″縺九↑?
  (interactive)
...
(defun sense-region-set-symbol (&optional position start) ; mell 陦後″縺九↑?
  (interactive)
  (or position (setq position (point)))
...
(defun sense-region-set-url (&optional position) ; mell 陦後″縺九↑?
  (interactive)
  (or position (setq position (point)))
  (goto-char position)
...
(defun sense-region-set-email (&optional position) ; mell 陦後″縺九↑?
  (interactive)
  (or position (setq position (point)))
  (goto-char position)
